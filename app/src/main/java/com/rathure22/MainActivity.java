...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if(btnAuto != null) btnAuto.setOnClickListener(v -> { if(tvStatus != null) tvStatus.setText("AUTO Toggled"); Toast.makeText(this,"AUTO",Toast.LENGTH_SHORT).show(); });
            if(btnLock != null) btnLock.setOnClickListener(v -> { if(tvStatus != null) tvStatus.setText("LOCKED"); });
            if(btnAlarm != null) btnAlarm.setOnClickListener(v -> { if(tvStatus != null) tvStatus.setText("ALARM Active"); });
            if(btnX2 != null) btnX2.setOnClickListener(v -> { multiplier=2; if(tvStatus != null) tvStatus.setText("x2"); });
            if(btnX3 != null) btnX3.setOnClickListener(v -> { multiplier=3; if(tvStatus != null) tvStatus.setText("x3"); });
            if(btnX4 != null) btnX4.setOnClickListener(v -> { multiplier=4; if(tvStatus != null) tvStatus.setText("x4"); });
